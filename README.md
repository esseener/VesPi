...
<p align="center">
  ...
  <a href="https://github.com/esseener/VesPi/releases/latest">下载 1.0.6</a>
</p>
...
当前版本 **[1.0.6](https://github.com/esseener/VesPi/releases/tag/v1.0.6)**。
...
- 安装包：`VesPi-Setup-1.0.6-win-x64.exe`（推荐，装到 `%LOCALAPPDATA%\Programs\VesPi\`）
- 便携包：`VesPi-1.0.6-win-x64.exe`
...
- Installer: `VesPi-Setup-1.0.6-win-x64.exe`
- Portable: `VesPi-1.0.6-win-x64.exe`
